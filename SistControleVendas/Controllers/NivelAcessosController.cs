...
namespace SistControleVendas.Controllers
{
    public class NivelAcessosController : Controller
    {
        ...
        public NivelAcessosController(ControleVendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NivelAcessoID,Descricao")] NivelAcesso nivelAcesso)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NivelAcessoID,Descricao")] NivelAcesso nivelAcesso)
        {
