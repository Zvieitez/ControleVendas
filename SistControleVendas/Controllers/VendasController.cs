...
namespace SistControleVendas.Controllers
{
    public class VendasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("VendaID,ColaboradorID,ClienteID,DataVenda,Produto,Qtde,Valor,TotalVenda,FormaPgto")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VendaID,ColaboradorID,ClienteID,DataVenda,Produto,Qtde,Valor,TotalVenda,FormaPgto")] Venda venda)
        {
            if (id != venda.VendaID)
            {
                return NotFound();
