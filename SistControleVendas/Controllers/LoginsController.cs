...
namespace SistControleVendas.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LoginID,LoginNome,Senha,NivelAcesso")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LoginID,LoginNome,Senha,NivelAcesso")] Login login)
        {
            if (id != login.LoginID)
            {
                return NotFound();
